...
function Footer() {
  return (
    ...
    <div className="bg-black text-white p-10">
      <div className="bg-black text-white md:flex space-y-5 md:space-y-0">
        ...
        <div className="grid md:grid-cols-3 grid-cols-2 md:w-[60%] gap-10">
          <div>
            <p className="font-semibold text-xl">About</p>
            <div className="flex flex-col space-y-3 font-medium  mt-5">
              <a>How it works</a>
              <a>Featured</a>
              <a>Partnership</a>
